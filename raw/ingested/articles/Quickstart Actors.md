...
source: "https://docs.dapr.io/getting-started/quickstarts/actors-quickstart/"
author:
published:
created: 2026-05-03
...
tags:
  - "raw"
---
Let’s take a look at Dapr’s [Actors building block](https://docs.dapr.io/developing-applications/building-blocks/actors/). In this Quickstart, you will run a smart device microservice and a simple console client to demonstrate the stateful object patterns in Dapr Actors.
...
![](https://docs.dapr.io/images/actors-quickstart/actors-quickstart.png)
...
![](https://docs.dapr.io/images/actors-quickstart/actor-client-interaction-zipkin.png)
...
1. Two `SmokeDetectorActor` actors were [created in the client application](https://github.com/dapr/quickstarts/blob/master/actors/csharp/sdk/client/Program.cs) and initialized with object state with:
	...
	```
2. The [`DetectSmokeAsync` method of `SmokeDetectorActor 1` is called](https://github.com/dapr/quickstarts/blob/master/actors/csharp/sdk/service/SmokeDetectorActor.cs#L70).
	```csharp
	...
	```
3. The [`TriggerAlarmForAllDetectors` method of `ControllerActor` is called](https://github.com/dapr/quickstarts/blob/master/actors/csharp/sdk/service/ControllerActor.cs#L54). The `ControllerActor` internally triggers all alarms when smoke is detected
	```csharp
	...
	```
4. The [`SoundAlarm` methods](https://github.com/dapr/quickstarts/blob/master/actors/csharp/sdk/service/SmokeDetectorActor.cs#L78) of `SmokeDetectorActor 1` and `2` are called.
	```csharp
...
Learn more about [the Actor building block](https://docs.dapr.io/developing-applications/building-blocks/actors/)
