...
> [!primary] Note
> If you haven’t already, [try out the workflow quickstart](https://docs.dapr.io/getting-started/quickstarts/workflow-quickstart/) for a quick walk-through on how to use workflows.
...
![Diagrid Dashboard showing local workflow executions](https://docs.dapr.io/images/workflow-overview/workflow-diagrid-dashboard.png)
