...
source: "https://docs.dapr.io/getting-started/quickstarts/workflow-quickstart/"
author:
published:
created: 2026-05-03
...
Let’s take a look at the Dapr [Workflow building block](https://docs.dapr.io/developing-applications/building-blocks/workflow/workflow-overview/). In this Quickstart, you’ll create a simple console application to demonstrate Dapr’s workflow programming model and the workflow management APIs.
...
![](https://docs.dapr.io/images/workflow-quickstart-overview.png)
...
![](https://docs.dapr.io/images/workflow-quickstart-controlflow.png)
...
In the terminal, start the order processor app alongside a Dapr sidecar using [Multi-App Run](https://docs.dapr.io/developing-applications/local-development/multi-app-dapr-run/). From the `python/sdk` directory, run the following command:
...
![](https://docs.dapr.io/images/workflow-trace-spans-zipkin.png)
...
In the terminal, start the order processor app alongside a Dapr sidecar using [Multi-App Run](https://docs.dapr.io/developing-applications/local-development/multi-app-dapr-run/). From the `javascript/sdk` directory, run the following command:
...
In the terminal, start the order processor app alongside a Dapr sidecar using [Multi-App Run](https://docs.dapr.io/developing-applications/local-development/multi-app-dapr-run/). From the `csharp/sdk` directory, run the following command:
...
![](https://www.youtube.com/watch?v=BxiKpEmchgQ)
...
In the terminal, start the order processor app alongside a Dapr sidecar using [Multi-App Run](https://docs.dapr.io/developing-applications/local-development/multi-app-dapr-run/). From the `java/sdk` directory, run the following command:
...
In the terminal, start the order processor app alongside a Dapr sidecar using [Multi-App Run](https://docs.dapr.io/developing-applications/local-development/multi-app-dapr-run/). From the `go/sdk` directory, run the following command:
...
If your workflow is waiting for an [external event](https://docs.dapr.io/developing-applications/building-blocks/workflow/workflow-patterns/#external-system-interaction), you can raise one. It takes a single argument in the format of `<instance-id>/<event-name>`.
...
> [!warning] Important
> It is required that a workflow client is running in the application to perform purge operations. The workflow client connection is required in order to preserve the workflow state machine integrity and prevent corruption. Errors like the following suggest that the workflow client is not running:
> 
> ```
...
- Set up Dapr Workflow with any programming language using [HTTP instead of an SDK](https://docs.dapr.io/developing-applications/building-blocks/workflow/howto-manage-workflow/)
- Walk through a more in-depth [.NET SDK example workflow](https://github.com/dapr/dotnet-sdk/tree/master/examples/Workflow)
- Learn more about [Workflow as a Dapr building block](https://docs.dapr.io/developing-applications/building-blocks/workflow/workflow-overview/)
```
