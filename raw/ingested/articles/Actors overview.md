...
![](https://docs.dapr.io/images/actor_background_game_example.png)
...
[Learn more about namespaced actors and how they work.](https://docs.dapr.io/developing-applications/building-blocks/actors/namespaced-actors/)
...
[Learn more about actor lifetimes.](https://docs.dapr.io/developing-applications/building-blocks/actors/actors-features-concepts/#actor-lifetime)
...
[Learn more about Dapr actor placement.](https://docs.dapr.io/developing-applications/building-blocks/actors/actors-features-concepts/#actor-placement-service)

### Actor communication

You can invoke actor methods by calling them over HTTP, as shown in the general example below.

![](https://docs.dapr.io/images/actors-calling-method.png)
...
[Learn more about calling actor methods.](https://docs.dapr.io/developing-applications/building-blocks/actors/actors-features-concepts/#actor-communication)
...
- [Learn more about actor reentrancy](https://docs.dapr.io/developing-applications/building-blocks/actors/actor-reentrancy/)
- [Learn more about the turn-based access model](https://docs.dapr.io/developing-applications/building-blocks/actors/actors-features-concepts/#turn-based-access)

### State

Transactional state stores can be used to store actor state. Regardless of whether you intend to store any state in your actor, you must specify a value for property `actorStateStore` as `true` in the state store component’s metadata section. Actors state is stored with a specific scheme in transactional state stores, allowing for consistent querying. Only a single state store component can be used as the state store for all actors. Read the [state API reference](https://docs.dapr.io/reference/api/state_api/) and the [actors API reference](https://docs.dapr.io/reference/api/actors_api/) to learn more about state stores for actors.
...
![](https://www.youtube.com/watch?v=0y7ne6teHT4)
- [Learn more about actor timers.](https://docs.dapr.io/developing-applications/building-blocks/actors/actors-features-concepts/#timers)
...
- [Learn more about timer and reminder error handling and failover.](https://docs.dapr.io/developing-applications/building-blocks/actors/actors-features-concepts/#timers-and-reminders-error-handling)
...
- Refer to the [Dapr SDK documentation and examples](https://docs.dapr.io/developing-applications/sdks/#sdk-languages).
